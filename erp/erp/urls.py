...
urlpatterns = [
    ...
    path('ingresarServicio/', include('ventas.urls')),
    path('eliminarServicio/<int:id>/', include('ventas.urls')),
    ...
    path('obtenerServicios/', include('ventas.urls')),
    path('buscarVenta',include('ventas.urls')),
]   
